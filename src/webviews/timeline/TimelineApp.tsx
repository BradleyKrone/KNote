...
// laid out chronologically. Right-click any item to change its date.

import { useEffect, useMemo, useRef, useState } from 'react'
import dayjs from 'dayjs'
import { CheckCircle2, Circle, FileText, Flag } from 'lucide-react'
...
export function TimelineApp(): React.JSX.Element {
  ...
  useEffect(() => {
    if (scrolledOnce.current || notes.size === 0) return
