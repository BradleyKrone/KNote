...
//   - right-click the last cell of the last row: Insert row above/below,
//     Delete row and the column ops all act on *that* row and column, not the
//     header/first column — with and without a cell already open elsewhere in
//     the table, and the same again in Edit table source view
